...
import { ArrowDown, FolderOpen, FileCode, X, Cog } from "lucide-react";
...
export function UnifiedUpload({ 
  ...
  const onDrop = useCallback(async (acceptedFiles: File[]) => {
    ...
    try {
      ...
      setTimeout(() => {
        if (fileType === 'process') {
          onProcessAnalysisComplete(analysis);
          toast({
            ...
            <div className="flex items-center space-x-3">
              ...
              <div className="text-left">
                ...
                <p className="text-sm text-gray-500">
                  {(uploadedFile.size / 1024 / 1024).toFixed(1)} MB • {getAnalysisTypeDisplay()}
                </p>
              </div>
            </div>
            <Button
  ...
  return (
    <div className="text-center">
      ...
      >
        ...
        <ArrowDown className="mx-auto h-16 w-16 text-green-500 mb-4" />
